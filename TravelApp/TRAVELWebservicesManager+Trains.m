//
//  TRAVELWebservicesManager+Trains.m
//  TravelApp
//
...
@implementation TRAVELWebservicesManager (Trains)
...
{
    NSString * method = [[TRAVELWSConfiguration sharedInstance] getMethodForIdentifier:WS_GET_TRAINS];
    NSString * path = [[TRAVELWSConfiguration sharedInstance] getPathForIdentifier:WS_GET_TRAINS];
