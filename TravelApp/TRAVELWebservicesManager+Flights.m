//
//  TRAVELWebservicesManager+Flights.m
//  TravelApp
//
...
@implementation TRAVELWebservicesManager (Flights)


- (NSURLSessionDataTask * _Nullable)getFlightsWithSuccess:(void (^ _Nonnull)(NSArray * _Nonnull items))success
                                              andFailure:(void (^ _Nonnull)(NSError * _Nonnull error))failure
{
    NSString * method = [[TRAVELWSConfiguration sharedInstance] getMethodForIdentifier:WS_GET_FLIGHTS];
    NSString * path = [[TRAVELWSConfiguration sharedInstance] getPathForIdentifier:WS_GET_FLIGHTS];
